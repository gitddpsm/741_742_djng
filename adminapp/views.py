...
from django.views.generic.edit import DeleteView, UpdateView # CreateView, UpdateView
...
def db_profile_by_type(prefix, tupe, queries):
    update_queries = list(filter(lambda x: type in x['sql'], queries))
    print(f'db_profile {type} for {prefix}:')
    [print(querry['sql'] for query in update_queries)]
...
class ProductCategoryAble(DeleteView):
    # class ProductCategoryAble(DeleteView):
    model = ProductCategory
    template_name = 'adminapp/productcategory_confirm_able.html' # adminapp\templates\adminapp\productcategory_confirm_delete.html
    success_url = reverse_lazy('admin_staff:categories')

    def able(self, request, *args, **kwargs):
        self.object = self.get_object()
